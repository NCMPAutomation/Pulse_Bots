# Define variables
$bitnamiDrupalOvaUrl = "https://bitnami.com/path-to-drupal-ova-file" # Replace with actual Bitnami OVA URL
$localOvaPath = "C:\Temp\bitnami-drupal.ova"                         # Path to save the OVA file
$vmName = "Bitnami_Drupal_VM"                                        # Virtual machine name
$vmxDirectory = "C:\VMs\Bitnami_Drupal"                              # Directory to store VMX files
$vmwareExecutable = "C:\Program Files (x86)\VMware\VMware Workstation\vmrun.exe" # Path to vmrun.exe

# Step 1: Download the Drupal OVA file
Write-Output "Downloading the Bitnami Drupal OVA file..."
Invoke-WebRequest -Uri $bitnamiDrupalOvaUrl -OutFile $localOvaPath
...
# Step 5: Provide Drupal access information
Write-Output "Access Drupal at: http://$vmIp"
