# Define variables
$bitnamiMeanOvaUrl = "https://bitnami.com/stack/mean/virtual-machine" # Replace with the actual Bitnami MEAN OVA URL
$localOvaPath = "C:\Temp\bitnami-mean.ova"                           # Path to save the OVA file
$vmName = "Bitnami_MEAN_VM"                                          # Virtual machine name
$vmxDirectory = "C:\VMs\Bitnami_MEAN"                                # Directory to store VMX files
$vmwareExecutable = "C:\Program Files (x86)\VMware\VMware Workstation\vmrun.exe" # Path to vmrun.exe

# Step 1: Download the MEAN OVA file
Write-Output "Downloading the Bitnami MEAN OVA file..."
Invoke-WebRequest -Uri $bitnamiMeanOvaUrl -OutFile $localOvaPath
...
# Step 5: Provide MEAN stack access information
Write-Output "Access the MEAN stack application at: http://$vmIp"
