# Define variables
$bitnamiTomcatOvaUrl = "https://bitnami.com/stack/tomcat/virtual-machine" # Replace with actual Bitnami Tomcat OVA URL
$localOvaPath = "C:\Temp\bitnami-tomcat.ova"                             # Path to save the OVA file
$vmName = "Bitnami_Tomcat_VM"                                            # Virtual machine name
$vmxDirectory = "C:\VMs\Bitnami_Tomcat"                                  # Directory to store VMX files
$vmwareExecutable = "C:\Program Files (x86)\VMware\VMware Workstation\vmrun.exe" # Path to vmrun.exe

# Step 1: Download the Tomcat OVA file
Write-Output "Downloading the Bitnami Apache Tomcat OVA file..."
Invoke-WebRequest -Uri $bitnamiTomcatOvaUrl -OutFile $localOvaPath
...
# Step 5: Provide Apache Tomcat access information
Write-Output "Access Apache Tomcat at: http://$vmIp:8080"
