# Define variables
$bitnamiElkOvaUrl = "https://bitnami.com/stack/elk/virtual-machine" # Replace with actual Bitnami ELK OVA URL
$localOvaPath = "C:\Temp\bitnami-elk.ova"                          # Path to save the OVA file
$vmName = "Bitnami_ELK_VM"                                         # Virtual machine name
$vmxDirectory = "C:\VMs\Bitnami_ELK"                               # Directory to store VMX files
$vmwareExecutable = "C:\Program Files (x86)\VMware\VMware Workstation\vmrun.exe" # Path to vmrun.exe

# Step 1: Download the ELK OVA file
Write-Output "Downloading the Bitnami ELK OVA file..."
Invoke-WebRequest -Uri $bitnamiElkOvaUrl -OutFile $localOvaPath
...
# Step 5: Provide ELK Stack access information
Write-Output "Access Elasticsearch at: http://$vmIp:9200"
Write-Output "Access Kibana at: http://$vmIp:5601"
