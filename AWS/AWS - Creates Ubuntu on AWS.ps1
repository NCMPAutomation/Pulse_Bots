...
$amiId = "ami-0dba2cb6798deb6d8"  # Replace with the AMI ID for Ubuntu (Example: Ubuntu 20.04 LTS in us-east-1)
...
Write-Host "Ubuntu EC2 instance launched successfully."
